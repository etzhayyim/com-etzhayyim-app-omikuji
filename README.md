...
| Then | Now |
|---|---|
| `svelte/src/routes/+page.svelte` (the status page) | [`cljs/src/omikuji/app.cljs`](appview/omikuji-mcp-component/cljs/src/omikuji/app.cljk) — same fields, faithfully ported |
